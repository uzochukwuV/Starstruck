  ...
  (begin
    ...
    (let (
      ...
      (let (
        ...
        ;; Transfer sBTC from LP provider to this contract. you are not using as-contract, then pass current-contract  as the recipient.
...
(define-public (rebalance-hedge (new-net-long bool) (delta-size uint))
  (begin
    ...
    (let (
      ...
      (if new-net-long
        ;; More longs than shorts  protocol shorts sBTC: swap xy internally.
        ...
        ;; More shorts than longs  protocol longs sBTC: swap yx internally.
